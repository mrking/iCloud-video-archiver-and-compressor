...
@patch("archive_videos.reimport._osascript")
def test_delete_original_exec_calls_osascript_with_uuid(mock_osascript: Any,
        sample_asset: VideoAsset,
    ) -> None:
...
@patch("archive_videos.reimport._osascript")
def test_import_compressed_dry_run_logs_and_returns_none(mock_osascript: Any,
        tmp_path: Path,
    ) -> None:
...
@patch("archive_videos.reimport._osascript")
def test_restore_metadata_exec_sets_date_favorite_albums(mock_osascript: Any,
        sample_asset: VideoAsset,
    ) -> None:
...
@patch("archive_videos.reimport._osascript")
def test_restore_metadata_no_date_no_albums_still_succeeds(mock_osascript: Any,
        asset_no_date_no_albums: VideoAsset,
    ) -> None:
...
@patch("archive_videos.reimport._osascript")
def test_restore_metadata_osascript_failure_is_warning_not_error(mock_osascript: Any,
        sample_asset: VideoAsset,
    ) -> None:
...
@patch("archive_videos.reimport._osascript")
def test_reimport_asset_execute_full_workflow(mock_osascript: Any,
        sample_asset: VideoAsset,
        tmp_path: Path,
    ) -> None:
    compressed = tmp_path / "compressed.mp4"
